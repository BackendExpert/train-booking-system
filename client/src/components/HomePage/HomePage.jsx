    ...
    <div className="">
        ...
        <div className="bg-gray-200 lg:px-24 px-10 py-20 ">
            ...
            <div className="lg:flex my-10">
                <div className="bg-white py-4 px-8 lg:mx-8 mx-0 w-full shadow-md rounded-xl lg:my-0 my-8">
                    <img src="https://img.freepik.com/free-photo/smiling-young-man-with-crossed-arms-outdoors_1140-255.jpg?t=st=1713421890~exp=1713425490~hmac=9c4dda8e57f2e71baa0ffbb050a93fd59dedcb0ac249afb131174cbfafe3fbd6&w=740" alt="" className='h-40 w-auto rounded ml-2 mt-[-30px] shadow-md' />
                    <div className="my-4">
